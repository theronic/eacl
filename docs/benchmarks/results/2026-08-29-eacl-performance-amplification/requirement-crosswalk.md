...
| Finite cache decisions use a mechanically checked specialization | Every current-cache partition is certified; Domain or source changes | generated current-cache decision and host specialization | complete ten-partition refinement and stale-artifact mutant | 5.10 |
