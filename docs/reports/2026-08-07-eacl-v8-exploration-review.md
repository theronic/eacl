...
1. **Single-flight deadlock fix** (small, empirically reproduced, absorbing failure): permit-before-deref restructure + regression test. Prerequisite for D3.
