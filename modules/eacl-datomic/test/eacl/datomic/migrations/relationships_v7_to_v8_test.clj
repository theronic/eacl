(ns eacl.datomic.migrations.relationships-v7-to-v8-test
  (:require [clojure.test :refer [deftest]]
            [datomic.api :as d]
            [eacl.datomic.schema :as schema]
            [eacl.datomic.core :as api]
            [eacl.datomic.storage :as admission]
            [eacl.datomic.migrations.relationships-v7-to-v8 :as migration]
            [eacl.relationships.migration-contract :as contract]))

(defn open-source []
  (let [uri (str "datomic:mem://v7-to-v8-" (random-uuid))
