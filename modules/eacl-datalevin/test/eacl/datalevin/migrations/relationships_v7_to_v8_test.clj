(ns eacl.datalevin.migrations.relationships-v7-to-v8-test
  (:require [clojure.test :refer [deftest]]
            ...
            [eacl.datalevin.migrations.relationships-v7-to-v8 :as migration]
...
(defn open-source
  ([] (open-source false))
  ([protected?]
   (let [dir (str (java.nio.file.Files/createTempDirectory "eacl-v7-to-v8-" (make-array java.nio.file.attribute.FileAttribute 0)))
