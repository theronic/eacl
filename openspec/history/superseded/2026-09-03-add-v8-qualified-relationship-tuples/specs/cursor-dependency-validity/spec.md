...
### Requirement: v8 cursors commit to fixed eight-slot relationship ordering

Relationship-read and authorization cursors SHALL identify the v8 endpoint ABI
...
#### Scenario: Old cursor reaches v8

- **WHEN** a cursor was minted for a four-slot or seven-slot experimental
  relationship ABI
- **THEN** the v8 client rejects it as incompatible
