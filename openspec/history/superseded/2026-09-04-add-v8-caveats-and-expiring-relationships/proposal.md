...
- **BREAKING:** accept only fresh/rebuilt v8 stores, reject incompatible or mixed Relationship data and old cache/cursor artifacts, and provide rebuild guidance without automatic migration or dual reads.
