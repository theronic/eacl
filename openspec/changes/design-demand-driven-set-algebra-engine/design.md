...
11. Run union-only matched-host gates and operator strategy/resource benchmarks. Run Datahike/MinIO cold/warm/eviction/exact-count qualification and version fixed accepted ceilings; keep raw summaries under ignored `target/benchmarks/` or in CI artifacts.
