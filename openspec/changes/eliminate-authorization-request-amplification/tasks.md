...
- [x] 13.6 Profile a forced completed-answer miss on the 48-server Datalevin fixture, remove measured EACL traversal and cache-publication inefficiencies without changing lookup semantics or counter contracts, and retain evidence for a warmed core p50 target below 2 ms on the measured host (not a portable SLA).
