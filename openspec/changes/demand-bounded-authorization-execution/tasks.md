...
- [x] 13.11 Qualify matched-v7 latency ratios by exact host and JVM class, including OS, architecture, OS version, processor, memory, heap, JDK, VM implementation, backend/runtime, and measurement method; reject incomplete metadata and report mismatches as not applicable without weakening portable correctness or deterministic-work gates.
