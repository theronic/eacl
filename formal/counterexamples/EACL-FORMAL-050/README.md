# EACL-FORMAL-050 — warm `can?` measured tiered compilation
...
5,000 calls. That is not a reliable steady-state fixture for the deep
Clojure-to-generated-Java authorization path on a shared HotSpot runner. A
fresh local 1 GiB JVM with forced generated authority measured 440.42 µs warm,
440.90 µs cold, and 17.25 µs for a completed-cache hit.
...
435.44 µs cold, and 14.79 µs for a completed-cache hit. The 1,000 µs ceiling is
unchanged: sustained slow service across batches still fails rather than being
hidden by one fast sample.
