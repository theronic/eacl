  ...
  (let [relation-datoms
    ...
    (with-redefs [engine/find-permission-defs
      ...
      (let [paths
            ...
            summary
            (engine/calc-direct-grant-relations
...
(deftest generated-javascript-acyclic-arrow-path-refines-source-control
