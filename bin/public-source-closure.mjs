...
const roots = [
  ...
  "eacl.core/security-keyring",
  "eacl.core/security-keyring?",
  "eacl.core/security-keyring-status",
  "eacl.core/replace-security-keyring!",
  "eacl.core/add-security-key!",
  "eacl.core/activate-security-key!",
  "eacl.core/retire-security-key!",
  ...
  "eacl.client.orchestration/export-authenticated-cache-snapshot",
  "eacl.client.orchestration/restore-authenticated-cache-snapshot!",
  "eacl.datomic.core/export-authenticated-cache-snapshot",
  "eacl.datomic.core/restore-authenticated-cache-snapshot!",
  "eacl.datahike.core/export-authenticated-cache-snapshot",
  "eacl.datahike.core/restore-authenticated-cache-snapshot!",
  "eacl.datascript.core/export-authenticated-cache-snapshot",
  "eacl.datascript.core/restore-authenticated-cache-snapshot!",
  "eacl.datalevin.core/export-authenticated-cache-snapshot",
  "eacl.datalevin.core/restore-authenticated-cache-snapshot!",
