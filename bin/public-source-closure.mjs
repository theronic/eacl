...
const roots = [
  ...
  "eacl.subproblem-cache/lookup-layered-bound!",
  "eacl.subproblem-cache/lookup!",
  "eacl.subproblem-cache/lookup-bound!",
  ...
  "eacl.datahike.core/DatahikeAuthorization",
  ...
  "eacl.datascript.core/DataScriptAuthorization",
